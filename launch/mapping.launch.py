"""Launch Livox drivers, lidar filters, and SLAM mapping."""
...
def _launch_setup(context):
    ...
    actions.append(
        IncludeLaunchDescription(
            ...
            launch_arguments={
                'mapping_params_file': _resolve_path(
                    slam_config['mapping_params_file']
                ),
            }.items(),
        )
    )
...
def generate_launch_description():
    """Generate the mapping launch description."""
